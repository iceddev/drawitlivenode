...
whiteboard.sendMessage = function(message){
  ...
  wsrpc.sendMessage(wbId,message).then(function(resp){
 ...
 var getUserList = function() {
  ...
  wsrpc.getUsers(wbId).then(function(users){
...
var showMovie = function(){
  ...
  var takePicture = function(){
    ...
    capture();
      ...
      var imgJSON = createImageJSON(bounds,canvas.toDataURL());
...
var submitUserName = function(){
    ...
    if(!unt.isValid()){
      ...
      wsrpc.getWhiteBoard(wbId, userName).then(function(result){
